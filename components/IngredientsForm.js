    ...
    render() {
        return (
            <Form>
                ...
                <FormGroup check>
                    <Label check>
                        <Input type="checkbox" name="gluten" checked={this.state.gluten} />{' '}
                        Gluten
                    </Label>
                </FormGroup>
                <FormGroup check>
                    <Label check>
                        <Input type="checkbox" name="nut" checked={this.state.nut} />{' '}
                        Nut
                    </Label>
                </FormGroup>
                <FormGroup check>
                    <Label check>
                        <Input type="checkbox" name="gmo" checked={this.state.gmo} />{' '}
                        GMO
                    </Label>
                </FormGroup>
